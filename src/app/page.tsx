...
export const metadata: Metadata = {
  title: "Baseball Player Statistics",
  description: "View and edit baseball player statistics",
}
...
export default async function Home() {
  return (
    ...
    <div className="container mx-auto py-6">
      <h1 className="text-3xl font-bold mb-6">Baseball Player Statistics</h1>
      <PlayerDashboard />
    </div>
